...
const HomeRecentActivityItem = ({activityItem:{
    emoji,
    link,
    title,
    type,
  ...
  return (
   <Link href={link}>
    <Card className='bg-background border-none hover:bg-accent transition-colors duration-200 p-2'>
        <CardContent className='flex w-full justify-between sm:itens-center p-2 sm:p-2 pt-0 '>
            <div className='flex flex-row sm:gap-4 gap-2 w-full'>
                <ReadOnlyEmoji selectedEmoji={emoji} className='sm:h-16 sm:w-16 h-12 w-12' />
