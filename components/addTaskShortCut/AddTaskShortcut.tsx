      ...
      <HoverCard openDelay={250} closeDelay={250}>
        <HoverCardTrigger asChild>
          <DialogTrigger asChild>
            <Button size="icon" variant="ghost" className='w-8 h-8 sm:w-9 sm:h-9' >
              <PencilRuler size={18} />
      ...
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          <div className='flex flex-col items-start gap-2'>
            {
              newTaskLink && (
                <Link target='_blank' href={newTaskLink} className='w-full cursor-pointer' onClick={()=>{
                  setOpen(false)
                }}>
                  <div className='mt-6 mb-4 p-2 border border-primary rounded-md bg-primary/10 w-ful text-primary font-semibold flex justify-between items-center'>
                  <p>
                    {
                      t("ADDED_TASK")
                    }
            ...
            <div className='flex items-center gap-2'>
              {
                currentTab==="workspaces" && (
                  ...
                  }} className='h-8 w-8' variant={"ghost"} size={"icon"}>
                    <ChevronLeft />
        ...
        {
          isError ? (
            <ClientError message='Error fetching workspaces' onRefetch={refetch} className='mt-0 sm:mt-0 md:mt-0' />
