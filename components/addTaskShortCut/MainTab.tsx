...
const MainTab = ({renderedEmoji,activeWorkspace,date,title,onSelectEmojiHandler,onChangeTabHandler,onSelectedDate,onChangeTitle}:Props) => {
  ...
  if(!activeWorkspace){
    ...
    return (
        ...
        <div className='flex gap-4 w-full items-center'>
            <EmojiSelector className='w-fit' onSelectedEmoji={onSelectEmojiHandler}  
            align='center'>
