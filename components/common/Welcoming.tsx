...
const Welcoming = React.forwardRef<HTMLDivElement,Props>(({className,hideOnMobile,hideOnDesktop,showOnlyOnPath,username,name,surname,...props},ref) => {
  ...
  return (
    <div ref={ref} {...props} className={cn(`space-y-1 ${hideOnDesktop ? "lg:hidden":""} ${
      ...
      <p className='font-bold sm:text-3xl text-2xl'>
        ...
        <span>
          {
            name ? name && surname ? `${name} ${surname}`:name:username
          }
        </span> { ""}
        👋
      </p>
