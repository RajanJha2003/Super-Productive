...
const InviteContent = ({workspace:{
  id,
  adminCode,
  canEditCode,
  inviteCode,readOnlyCode
}}:Props) => {
  ...
  const inviteUrl=useMemo(()=>{
    const shareCode=()=>{
      switch(selectedRole){
        case "admin":return codes.adminCode;
        case "editor":return codes.canEditCode;
        case "viewer":return codes.readOnlyCode;
      }
